...
\begin{eqnarray}
\hat{\sigma}^{2}=\frac{SC_{E}}{n-2}=MC_{E}, \textrm{ estimador insesgado de }\sigma^{2}.
\end{eqnarray}
...
\begin{eqnarray*}
\sigma(u) = \frac{1}{1 + e^{-u}} \quad \Rightarrow \text{clasificador de regresión logística}
\end{eqnarray*}
