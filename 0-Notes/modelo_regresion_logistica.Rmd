...
---
title: "Modelo de Regresión Logística y Probit"
author: "Carlos"
date: "`r Sys.Date()`"
output:
  html_document:
...
plot(x, y, pch = 19, col = ifelse(y == 1, "blue", "red"),
     main = "Logistic Regression Fit", xlab = "x = Auto Time - Bus Time",
     ylab = "P(car)")
...
x_sorted <- sort(x)
lines(x_sorted,
       predict(modelo, type = "response")[order(x)],
       col = "darkgreen", lwd = 2)
...
plot(x, y, pch = 19, col = ifelse(y == 1, "blue", "red"),
     ...
     xlab = "x = Auto Time - Bus Time", ylab = "P(car)", ylim = c(0, 1))
...
Ambos modelos, logístico y probit, ofrecen ajustes similares. Sin embargo, el modelo probit puede ser más adecuado cuando se esperan muchas observaciones en los extremos.
