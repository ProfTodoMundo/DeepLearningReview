...
# Apéndices: Documentos TeX relevantes

## Derivadas Regresion
```{=latex}
\input{derivadas_regresion.tex}
```

## Maalouf Logistic Regression Deducciones
```{=latex}
\input{maalouf_logistic_regression_deducciones.tex}
```

## Maalouf Logistic Regression Full
```{=latex}
\input{maalouf_logistic_regression_full.tex}
```

## Resumen Ai Ml Con Referencias Compila
```{=latex}
\input{resumen_AI_ML_con_referencias_COMPILA.tex}
```

## Resumen Ai Ml Con Referencias Final
```{=latex}
\input{resumen_AI_ML_con_referencias_FINAL.tex}
```

## Resumen Ai Ml Con Referencias Tikz
```{=latex}
\input{resumen_AI_ML_con_referencias_TIKZ.tex}
```

## Resumen Ai Ml Con Referencias
```{=latex}
\input{resumen_AI_ML_con_referencias.tex}
```

## Resumen Logistic Regression Completo
```{=latex}
\input{resumen_logistic_regression_completo.tex}
```

## Resumen Logistic Regression Formal
```{=latex}
\input{resumen_logistic_regression_formal.tex}
```



# Apéndices: Documentos TeX (versiones limpias)

## Derivadas Regresion
```{=latex}
\input{tex_cleaned/derivadas_regresion.tex}
```

## Maalouf Logistic Regression Deducciones
```{=latex}
\input{tex_cleaned/maalouf_logistic_regression_deducciones.tex}
```

## Maalouf Logistic Regression Full
```{=latex}
\input{tex_cleaned/maalouf_logistic_regression_full.tex}
```

## Resumen Ai Ml Con Referencias Compila
```{=latex}
\input{tex_cleaned/resumen_AI_ML_con_referencias_COMPILA.tex}
```

## Resumen Ai Ml Con Referencias Final
```{=latex}
\input{tex_cleaned/resumen_AI_ML_con_referencias_FINAL.tex}
```

## Resumen Ai Ml Con Referencias Tikz
```{=latex}
\input{tex_cleaned/resumen_AI_ML_con_referencias_TIKZ.tex}
```

## Resumen Ai Ml Con Referencias
```{=latex}
\input{tex_cleaned/resumen_AI_ML_con_referencias.tex}
```

## Resumen Logistic Regression Completo
```{=latex}
\input{tex_cleaned/resumen_logistic_regression_completo.tex}
```

## Resumen Logistic Regression Formal
```{=latex}
\input{tex_cleaned/resumen_logistic_regression_formal.tex}
```
