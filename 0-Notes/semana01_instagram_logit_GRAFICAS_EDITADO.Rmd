...
### Tema 2: Evaluación del modelo logístico

#### Criterios de evaluación

Para estimar la precisión del modelo, se calcularon las siguientes métricas: sensibilidad, especificidad y exactitud, de acuerdo con las siguientes fórmulas:
...
#### Ejemplo 1: Diagnóstico de cáncer de mama

```{r ejemplo1}
# Valores de la matriz de confusión
TP1 <- 40; FN1 <- 10; FP1 <- 5; TN1 <- 45
...
# Mostrar resultados
data.frame(Métrica = c("Exactitud", "Sensibilidad", "Especificidad"),
           Valor = round(c(accuracy1, sensitivity1, specificity1), 2))
```

#### Ejemplo 2: Predicción de sobrevida

```{r ejemplo2}
# Valores de la matriz de confusión
TP2 <- 70; FN2 <- 30; FP2 <- 20; TN2 <- 80
...
# Mostrar resultados
data.frame(Métrica = c("Exactitud", "Sensibilidad", "Especificidad"),
           Valor = round(c(accuracy2, sensitivity2, specificity2), 2))
```
